describe MedicationEventPresenter do
  ...
  it 'presents as a whole table row' do
    expect(decorated_meds.to_tr).to eq (
      "<tr class='medication-event'><td><a title=\"Edit Meds\" href=\"/meds/1/edit\">19:44</a></td><td>Meds</td><td class='medication-event-dose'><div class='value' data-toggle='tooltip' data-placement='top' title='10.0 Insulin units'><span class='number'>10</span> <span class='units'>u</span></div></td><td class='medication-event-insulin'>humalog</td></tr>"
    )
  end
  ...
  describe '#insulin_for_time' do
    ...
    it 'thinks bedtime lasts until 05:00' do
